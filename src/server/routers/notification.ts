...
export const mockNotifications: MockNotification[] = [
  // Patient notifications
  {
    ...
    messageHe: 'We found לך Match New With Therapist With 92% Match.',
    link: '/matches',
    isRead: false,
    emailSent: true,
  ...
  },
  {
    ...
    titleHe: 'Message New מDr. Rachel Cohen',
    message: 'You have a new message regarding your upcoming session.',
    messageHe: 'You have Message New בנוגע לSession הקרובה Your.',
    link: '/messages',
    isRead: false,
    emailSent: true,
  ...
  },
  {
    ...
    titleHe: 'הSession orSarah!',
    message: 'Your session with Dr. Rachel Cohen has been confirmed for Sunday at 10:00.',
    messageHe: 'הSession Your With Dr. Rachel Cohen orSarah ליום Sun בTime 10:00.',
    link: '/sessions',
    isRead: true,
    emailSent: true,
  ...
  },
  {
    ...
    titleHe: 'תזכורת לSession',
    message: 'Your session is scheduled for tomorrow at 10:00 AM.',
    messageHe: 'הSession Your מתוכננת למחר בTime 10:00.',
    link: '/sessions',
    isRead: true,
    emailSent: true,
  ...
  // Therapist notifications
  {
    ...
    titleHe: 'בקשת Patient New!',
    message: 'A new patient has requested to schedule a session with you.',
    messageHe: 'Patient חדש ביקש לקבוע Session איתך.',
  ...
  },
  {
    ...
    titleHe: 'Message New מPatient',
    message: 'You have a new message from Israel Israeli.',
    messageHe: 'You have Message New מIsrael Israeli.',
  ...
  },
  {
    ...
    titleHe: 'Session בעוד Time',
    message: 'Reminder: You have a session with Sarah Cohen at 11:30.',
    messageHe: 'תזכורת: You have Session With Sarah Cohen בTime 11:30.',
  ...
  },
  {
    ...
    titleHe: 'הפרופיל Your orשר!',
    message: 'Your therapist profile has been approved. You can now receive patient requests.',
    messageHe: 'פרופיל הTherapist Your orשר. כעת תוכל/י לקבל בקשs מPatients.',
