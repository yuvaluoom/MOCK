...
const mockTherapistNotifications: TherapistNotification[] = [
  {
    ...
    messageHe: 'Israel Israeli ביקש/ה לקבוע Session איתך.',
  ...
  },
  {
    ...
    messageHe: 'תזכורת: You have Session מתוכננת למחר בTime 10:00.',
    link: '/therapist/sessions',
    isRead: true,
    priority: 'normal',
    emailSent: true,
  ...
  },
  {
    ...
    titleHe: 'הפרופיל orשר!',
    message: 'Your therapist profile has been approved. You can now accept patients.',
    messageHe: 'פרופיל הTherapist Your orשר. כעת תוכל/י לקבל Patients.',
