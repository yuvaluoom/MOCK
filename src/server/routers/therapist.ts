...
const mockTherapistNotifications: TherapistNotification[] = [
  {
    ...
    titleHe: 'בקשה חדשה ממטופל',
    message: 'Israel Israeli has requested an appointment with you.',
    messageHe: 'ישראל ישראלי ביקש/ה לקבוע פגישה איתך.',
    link: '/therapist/sessions',
    isRead: false,
    priority: 'high',
    emailSent: true,
    createdAt: new Date(Date.now() - 30 * 60 * 1000), // 30 minutes ago
    metadata: { patientName: 'ישראל ישראלי', patientId: 'patient-1', sessionId: 'session-2' },
  },
  {
    id: 'tnotif-2',
    therapistId: 'therapist-1',
    ...
    metadata: { patientName: 'ישראל ישראלי', patientId: 'patient-1' },
  },
  {
    id: 'tnotif-3',
    therapistId: 'therapist-1',
    ...
    messageHe: 'תזכורת: יש לך פגישה מתוכננת למחר בשעה 10:00.',
    link: '/therapist/sessions',
    isRead: true,
    priority: 'normal',
    emailSent: true,
    createdAt: new Date(Date.now() - 24 * 60 * 60 * 1000), // 1 day ago
    metadata: { patientName: 'שרה כהן', sessionId: 'session-1' },
  },
  {
    id: 'tnotif-4',
    therapistId: 'therapist-1',
