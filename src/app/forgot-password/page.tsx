  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-calm-50/30 to-white flex items-center justify-center py-20">
      <div className="container mx-auto px-4 max-w-md">
        <h1 className="text-3xl font-bold text-gray-900 mb-2 text-center">שBack Password</h1>
        <p className="text-gray-600 text-center mb-8">הזינו את Address הEmail שלכם ונSend לכם קישור Noיפוס הPassword.</p>
        {submitted ? (
          <div className="bg-calm-50 rounded-2xl p-8 text-center text-calm-700">
            <p className="font-medium">הקישור נSend בהצלחה!</p>
