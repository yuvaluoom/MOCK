    ...
    const therapistData: Array<Omit<DbTherapist, 'createdAt' | 'updatedAt'>> = [
      {
        ...
        bioHebrew: 'Specializes in Cognitive Behavioral Therapy with over 12 years of experience.',
        city: 'Tel Aviv',
        address: '120 Dizengoff St.',
      ...
      },
      {
        ...
        bioHebrew: 'Experienced in trauma therapy and EMDR for veterans and civilians.',
        city: 'Jerusalem',
        address: '42 Jaffa St.',
      ...
      },
      {
        ...
        bioHebrew: 'Specializing in child and adolescent therapy with art therapy integration.',
        city: 'Haifa',
        address: '88 Herzl St.',
      ...
      },
      {
        ...
        bioHebrew: 'Professor of clinical psychology specializing in couples and family therapy.',
        city: 'Tel Aviv',
        address: '55 Rothschild Blvd.',
      ...
      },
      {
        ...
        bioHebrew: 'Focusing on mindfulness-based therapy and stress management for young adults.',
        city: 'Ramat Gan',
      ...
      // NEW: Therapist awaiting approval
      {
        ...
        bioHebrew: 'New therapist awaiting approval.',
        city: 'Haifa',
        address: '15 HaNamal St.',
      ...
      // NEW: Therapist with missing documents
      {
        ...
        bioHebrew: 'Therapist with missing documents.',
        city: 'Beer Sheva',
        address: '8 Reger St.',
    ...
    const matchData: Array<Omit<DbMatch, 'createdAt' | 'updatedAt'>> = [
      {
        ...
        scoreBreakdown: {},
        explanationHe: 'Very high therapeutic compatibility',
        explanationEn: 'Very high therapeutic compatibility',
        explanationItems: [
          { category: 'practical', matched: true, labelHe: 'Health fund match', labelEn: 'Health fund match' },
      ...
      },
      {
        ...
        scoreBreakdown: {},
        explanationHe: 'High therapeutic compatibility',
        explanationEn: 'High therapeutic compatibility',
        explanationItems: [
          { category: 'practical', matched: false, labelHe: 'Health Fund No Matching', labelEn: 'Health fund mismatch' },
          { category: 'objective', matched: true, labelHe: 'Experience With Military Service', labelEn: 'Military experience' },
          { category: 'subjective', matched: false, labelHe: 'Communication style No Match', labelEn: 'Communication style mismatch' },
        ],
        isViewed: false,
        isFavorited: false,
        isHidden: false,
