...
export function getSupportedFields(entityType: ImportEntityType): {
  ...
  switch (entityType) {
    case 'therapist':
      return [
        { field: 'email', label: 'אימייל', required: true, type: 'email' },
        { field: 'fullName', label: 'שם מלא', required: true, type: 'string' },
        { field: 'licenseNumber', label: 'מספר רישיון', required: true, type: 'string' },
        { field: 'firstName', label: 'שם פרטי', required: false, type: 'string' },
        { field: 'lastName', label: 'שם משפחה', required: false, type: 'string' },
        { field: 'phone', label: 'טלפון', required: false, type: 'phone' },
        { field: 'gender', label: 'מין', required: false, type: 'enum' },
        { field: 'licenseType', label: 'סוג רישיון', required: false, type: 'enum' },
        { field: 'yearsExperience', label: 'שנות ניסיון', required: false, type: 'number' },
        { field: 'education', label: 'השכלה', required: false, type: 'array' },
        { field: 'specializations', label: 'התמחויות', required: false, type: 'array' },
        { field: 'therapeuticApproaches', label: 'גישות טיפוליות', required: false, type: 'array' },
        { field: 'languages', label: 'שפות', required: false, type: 'array' },
        { field: 'healthFunds', label: 'קופות חולים', required: false, type: 'array' },
        { field: 'city', label: 'עיר', required: false, type: 'string' },
        { field: 'address', label: 'כתובת', required: false, type: 'string' },
        { field: 'supportsOnline', label: 'טיפול אונליין', required: false, type: 'boolean' },
        { field: 'supportsInPerson', label: 'טיפול פרונטלי', required: false, type: 'boolean' },
        { field: 'sessionPrice', label: 'מחיר פגישה', required: false, type: 'number' },
      ];
    case 'patient':
      return [
        { field: 'email', label: 'אימייל', required: true, type: 'email' },
        ...
        { field: 'phone', label: 'טלפון', required: false, type: 'phone' },
        { field: 'gender', label: 'מין', required: false, type: 'enum' },
        { field: 'birthDate', label: 'תאריך לידה', required: false, type: 'date' },
        { field: 'healthFund', label: 'קופת חולים', required: false, type: 'enum' },
        { field: 'preferredCity', label: 'עיר מועדפת', required: false, type: 'string' },
        { field: 'preferredLanguages', label: 'שפות מועדפות', required: false, type: 'array' },
        { field: 'preferredGender', label: 'העדפת מין מטפל', required: false, type: 'enum' },
      ];
    case 'organization':
      return [
        { field: 'name', label: 'שם', required: true, type: 'string' },
        { field: 'type', label: 'סוג', required: true, type: 'enum' },
        { field: 'code', label: 'קוד', required: false, type: 'string' },
        { field: 'contactEmail', label: 'אימייל', required: false, type: 'email' },
        { field: 'contactPhone', label: 'טלפון', required: false, type: 'phone' },
        { field: 'address', label: 'כתובת', required: false, type: 'string' },
        { field: 'city', label: 'עיר', required: false, type: 'string' },
      ];
    default:
